...
import { Target, TrendingUp, Activity, Dumbbell, Zap, Download } from "lucide-react";
  ...
  const handleExportPDF = async () => {
    ...
    try {
      const canvas = await html2canvas(element, {
        ...
        useCORS: true,
        backgroundColor: '#050505', // Match system-bg
      });
      ...
      pdf.save("relatorio_cacador.pdf");
    } catch (error) {
      ...
      <div className="p-4 md:p-8 max-w-[1500px] mx-auto space-y-8 pb-20">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-[#2A2A2A] pb-5">
          ...
          <button 
            ...
            className="flex items-center gap-2 bg-[#181818] border border-[#2A2A2A] hover:border-[#00E5FF] hover:text-[#00E5FF] text-white px-4 py-2 rounded transition-colors font-title tracking-[1px] disabled:opacity-50 disabled:cursor-not-allowed"
          >
        ...
        <div id="relatorio-content" className="space-y-8 pb-4">
          {/* TOP CARDS */}
